...
void Application::setupScene()
{
    ...
    std::uniform_real_distribution<float> velY(-10.0f, 0.0f);
    std::uniform_real_distribution<float> velZ(-5.0f, 5.0f);
    ...
    for (int i = 0; i < 1000; ++i) {
        ...
        // Initialize velocity
        sphere.setVelocity(glm::vec3(velX(gen), velY(gen), velZ(gen)));
    }
}